...
if text == (database:get(bot_id.."Killer:Name:Bot") or "تشاكيx") then
Namebot = (database:get(bot_id.."Killer:Name:Bot") or "تشاكيx")
local namebot = {
...
local Name_Bot = (database:get(bot_id.."Killer:Name:Bot") or "تشاكيx")
